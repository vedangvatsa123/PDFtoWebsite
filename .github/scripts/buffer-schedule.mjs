...
const IG_POSTS = [
  ...
  `We run a job board. 6,000+ listings went through it this month.\n\nBackend dev is the most posted role. But almost every listing now asks for AI experience. Not AI-specific jobs. Regular backend roles.\n\ncvin.bio/jobs\n\n#hiring #backend #ai #jobmarket #careeradvice`,
  `We run a job board with 6,000+ listings. Two years ago every company posted for builders. Now they need people to keep it running.\n\nDevOps and infrastructure roles grew 40% on our board this quarter.\n\ncvin.bio/jobs\n\n#devops #infrastructure #hiring #techjobs #careeradvice`,
  `We looked at what skills show up most across 6,000+ job listings on our board.\n\nPython and TypeScript are in everything. Go is climbing. Java is fading from most startups and mid-size companies.\n\nDegrees keep mattering less too.\n\ncvin.bio\n\n#python #typescript #programming #techskills #jobmarket`,
  `We run a job board. The thing that keeps jumping out from the data: barely any junior roles.\n\nMost of what gets posted is senior or above. If you are early career, the normal path of applying and hoping barely exists anymore.\n\ncvin.bio/layoffs-report\n\n#juniordev #entrylevel #hiring #jobmarket #careeradvice`,
