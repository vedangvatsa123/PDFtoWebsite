            ...
            <Dialog open={showCelebration} onOpenChange={setShowCelebration}>
                <DialogContent className="max-w-sm text-center">
                    ...
                    <div className="flex flex-col items-center gap-4 py-2">
                        ...
                        <div>
                            <h2 className="text-xl font-bold">Your profile is live!</h2>
                            <p className="text-sm text-muted-foreground mt-1">Share it anywhere — your resume is now a link.</p>
                        </div>
                        <div className="w-full bg-secondary rounded-lg px-3 py-2.5 flex items-center justify-between gap-2">
                            ...
                            <button
                                onClick={() => { navigator.clipboard.writeText(`https://cvin.bio/${celebrationSlug}`); }}
                        ...
                        <div className="flex gap-2 w-full">
                            <button
                                onClick={() => window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://cvin.bio/${celebrationSlug}`)}`, '_blank')}
                                className="flex-1 inline-flex items-center justify-center gap-2 rounded-lg border border-[#0A66C2] text-[#0A66C2] text-sm font-semibold py-2 hover:bg-[#0A66C2]/10 transition-colors"
                            >
                            ...
                            <button
                                onClick={() => window.open(`https://wa.me/?text=${encodeURIComponent(`My resume is now a website 🚀 cvin.bio/${celebrationSlug}`)}`, '_blank')}
                                className="flex-1 inline-flex items-center justify-center gap-2 rounded-lg border border-[#25D366] text-[#25D366] text-sm font-semibold py-2 hover:bg-[#25D366]/10 transition-colors"
                            >
