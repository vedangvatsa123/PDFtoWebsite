...
export const metadata: Metadata = {
  ...
  description: 'AI converts your CV into a personal website in seconds. Share your professional portfolio with a custom cvin.bio link.',
  ...
  openGraph: {
    ...
    description: 'AI converts your CV into a personal website in seconds.',
  },
  twitter: {
